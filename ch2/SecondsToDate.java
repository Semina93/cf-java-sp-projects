...
/**
 * Λαμβάνει έναν ακέραιο που συμβολίζει δευτερόλεπτα
 * και μετατρέπει σε ημέρες, ώρες, λεπτά και δευτερόλεπτα
 */
public class SecondsToDate {
    public static void main(String[] args) {
        ...
        System.out.printf("Total seconds %,d, days %,d, hours %02d, minutes %02d, remaining seconds %02d"
